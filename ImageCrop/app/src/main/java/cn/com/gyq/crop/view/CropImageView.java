...
public class CropImageView extends ImageView {
    private static final String TAG = "jack_CropImageView";
    ...
    public Bitmap getCroppedImage() {
        ...
        final float originalBitmapWidth = (float) originalBitmap.getWidth();
        final float originalBitmapHeight = (float) originalBitmap.getHeight();
        Log.i(TAG,"cropX="+cropX+" , cropY="+cropY);
        Log.i(TAG,"originalBitmapWidth="+originalBitmapWidth+" , originalBitmapHeight="+originalBitmapHeight);

        float tempH1=.0f,tempH2=.0f;
        final float cropWidth = Math.min(Edge.getWidth() / scaleX, originalBitmapWidth - cropX);
        float cropHeight = Math.min(tempH1=Edge.getHeight() / scaleY, tempH2=originalBitmapHeight - cropY);
        cropHeight = cropHeight < 0 ? tempH2:cropHeight;
        Log.i(TAG,"tempH1="+tempH1+" , tempH2="+tempH2);
        ...
        try {
            ...
            Log.e(TAG,"faile info >>> cropWidth="+cropWidth+" ,cropHeight= "+cropHeight);
            e.printStackTrace();
        }
